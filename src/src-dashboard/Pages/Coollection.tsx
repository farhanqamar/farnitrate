  ...
  return (
    <section className='space-y-2 p-4'>
            ...
            <div className='flex justify-between'>
                ...
                <Link to={"/admin/prooduct/newproduct"}><button className='bg-gradient-to-b text-base px-4 from-black/80 to-black/70 hover:bg-black text-white rounded-lg p-1 font-semibold'>Create collection</button></Link>
            </div>
